...
1. I need to either create a plan or give a structured prompt to the AI agent to create a plan.
2. Verify the plan and make corrections so that the generated code will meet our end goals in a desired way, following software development principles. We can modify the plan to follow modular architecture, check the dependencies used, the security principles followed, documentation, tests, and other stuff.
3. Execute the plan to generate code. In between, monitor the activities of the agent and give input wherever needed.
4. After the execution, check the difference between the previous and current version of the code. Check whether the end goals and software principles that we desired have been achieved.
5. Test this implementation end to end and commit this change. Then repeat this flow.
I am not saying this covers all aspects of software development; there are a lot of other things like handling customer requirements, deployment, and many other nuances. But the above part was the most time-consuming task in the past, and it has been simplified a lot now. There are still times when I have to manually write a piece of code to fix a bug or to achieve a particular end goal. But day by day it is becoming less and less a part of my work.
